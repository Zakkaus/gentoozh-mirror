...
export const MESSAGES = {
  'zh-cn': {
    ...
    mirrorTitle: '下载镜像',
    mirrorLead: '源站总是最新的一版。教育网镜像在中国大陆通常快得多，但它们按计划同步，新版本要等下一次同步才会出现。下面每一项都按当前版本核对过。',
    mirrorSource: '源站',
    ...
    mirrorReady: '已有这一版',
    mirrorBehind: '尚未同步这一版',
    mirrorUnknown: '状态无法确认',
    mirrorGo: '下载',
    mirrorBrowse: '打开目录',
    mirrorGoOf: name => `从${name}下载`,
  ...
  'zh-tw': {
    ...
    mirrorTitle: '下載鏡像',
    mirrorLead: '源站永遠是最新的一版。教育網鏡像在中國大陸通常快得多，但它們按排程同步，新版本要等下一次同步才會出現。下面每一項都按目前版本核對過。',
    mirrorSource: '源站',
    ...
    mirrorReady: '已有這一版',
    mirrorBehind: '尚未同步這一版',
    mirrorUnknown: '狀態無法確認',
    mirrorGo: '下載',
    mirrorBrowse: '開啟目錄',
    mirrorGoOf: name => `從${name}下載`,
  ...
  'en': {
    ...
    mirrorTitle: 'Mirrors',
    mirrorLead: 'The source always carries the newest build. The education-network mirrors are much faster inside mainland China, but they sync on a schedule, so a new build only appears after their next run. Each one below was checked against the current build.',
    mirrorSource: 'Source',
    ...
    mirrorReady: 'Has this build',
    mirrorBehind: 'Not synced yet',
    mirrorUnknown: 'Could not check',
    mirrorGo: 'Download',
    mirrorBrowse: 'Open directory',
    mirrorGoOf: name => `Download from ${name}`,
